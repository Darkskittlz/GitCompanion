...
function M.show_help()
   ...
   local lines = {
      ...
      "",
      "  Branch View (Left / Right Panels)",
      "    <Space>       : Checkout selected branch",
      "    p             : Pull latest changes from origin",
      "    d             : Delete branch (Left) / Revert commit (Right Log)",
      "    +             : Toggle maximize commit log view (Right Log)",
      "",
      "  File View (Left Panel)",
      "    <Space>       : Stage / Unstage file or folder",
      "    d             : Discard working tree changes",
      "",
      "  Stash View (Left Panel)",
      "    <Space>       : Pop selected stash",
      "    d             : Drop selected stash",
      "",
      "  Global Actions",
      "    s             : Create new stash (Any view)",
      "    ?             : Show this help modal",
      "    q / <Esc>     : Close companion UI or popup",
   }
