...
function M.show_help()
   local buf = vim.api.nvim_create_buf(false, true)
	...
	local lines = {
		...
		"    m             : Open merge menu (Merge into current branch)",
		"    P             : Push selected branch",
		"    r             : Rename selected branch",
		"    y             : Yank selected branch name to clipboard",
		"    x             : Delete branch ",
		"    +             : Toggle maximize commit log view ",
		"",
		"  Commits ",
		"    x             : Drop commit",
		"    p             : Pull changes for current branch",
		"    r             : Rename commit",
		"",
		"  Files ",
		"    <Space>       : Stage / Unstage selected file or folder",
		"    x             : Discard working file change",
		"",
		"  Stashes ",
		"    <Space>       : Pop selected stash",
		"    x             : Drop selected stash",
		"",
		"  Global Actions",
		"    s             : Create new stash ",
