...
function M.show_help()
   ...
   local lines = {
      ...
      "    c             : Checkout Remote Branch (Branches) / Open Commit Modal (Files)",
      "    d             : Delete Branch / Discard Changes / Drop Stash / Revert Commit",
      "    s             : Create new stash (Any view)",
      "",
      "  Commit Log Actions (Right Panel)",
      "    +             : Open expanded / full-screen Commit view",
      "    g             : Open Reset / Rebase modal (Mixed, Soft, Hard)",
      "    r             : Rename / Reword commit under cursor",
      "    y             : Yank commit metadata (ID, Title, Desc, Author, Date)",
      "",
      "  General",
      "    ?             : Show this help modal",
      "    q / <Esc>     : Close help, modal, or active popup",
   }
