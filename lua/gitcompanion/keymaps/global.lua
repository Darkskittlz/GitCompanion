...
function M.attach(buf, state)
   ...
   -- -------------------------------------------------------------------------
   -- Helper to Wrap Synchronous Mutating Actions
   -- -------------------------------------------------------------------------
   local function bind_mutating_map(mode, lhs, action_fn, opts)
      vim.keymap.set(mode, lhs, function()
         action_fn()
         -- Refetch and reload immediately after synchronous operation completes
   ...
   -- -------------------------------------------------------------------------
   -- Read-Only / Navigation Maps (NO RELOAD NEEDED)
   -- -------------------------------------------------------------------------
   ...
   -- -------------------------------------------------------------------------
   -- Interactive Mutating Map (Reload inside async callback)
   -- -------------------------------------------------------------------------
